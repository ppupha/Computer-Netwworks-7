...
FROM = 'nguyensangqh@gmail.com'
TO = 'nguyensangqqhh@gmail.com'
PAS = ''
SUBJ = 'Msg from python'
MSG = 'Hello there'
KEY = 'key'
SMTP_HOST = ["smtp.gmail.com", 2525]


def input_data():
    global TO, FROM, PAS, SUBJ, MSG, KEY
    TO = "nguyensangqh@gmail.com"#input("Enter receiver email address: ")
    FROM = "nguyensanghqqhh@gmail.com"#input("Enter sender email address: ")
    PAS = "Tuanhungnguyen" #input("Enter sender password: ")
    SUBJ = "Hello" #input("Enter mail subject: ")
    MSG = """\
                Hi,
                How are you?
